			...
			<div class="footer-top">
				...
				<div class="col_1_of_4 span_1_of_4">
					<div class="textcontact">
						<p>C E L L U L O I D<br>
						A Complete Movie Site<br>
						Ph: 6238157839<br>
						</p>
					</div>
				</div>
				<div class="col_1_of_4 span_1_of_4">
					<div class="call_info">
						...
						<p class="txt_4">1 800 369 369369</p>
					</div>
				</div>
				<div class="col_1_of_4 span_1_of_4">
					<div class=social>
						...
						<div class="footer-nav">
		            		...
		            		<li><a href="admin/index.php" style="text-decoration:none;">Admin Login</a></li>
			  		   		<li><a href="theatre/index.php" style="text-decoration:none;">Theatre Login</a></li>
		                </ul>
		              </div>
					</div>
				</div>
